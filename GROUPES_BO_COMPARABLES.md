# Challenge Satisfaction Client — Regroupement Oct. 2025 à Mars 2026 (Clean)

## Objectif

Refaire les groupes BO **à partir des stats réelles du 1er octobre 2025 au 31 mars 2026**  
et relancer une simulation de challenge pour une campagne cible en mai.

Fichier source:
- `/home/ubuntu/.cursor/projects/workspace/uploads/stats_octobre_2025_mars_2026.csv`
...
## Résultats actuels (mode par défaut = KMeans, dataset Oct→Mars)

- Silhouette KMeans: **0.2537**
- Silhouette Ward: **0.2364**
...
**Prix Effort simulé**: **BO Oullins** (+1.85 pts)
...
### KMeans (défaut)
1. `STATS_FILE="/home/ubuntu/.cursor/projects/workspace/uploads/stats_octobre_2025_mars_2026.csv" python3 analyse_groupes_bo.py`
2. `STATS_FILE="/home/ubuntu/.cursor/projects/workspace/uploads/stats_octobre_2025_mars_2026.csv" python3 simulation_challenge.py`

### Manuel
1. `GROUPING_MODE=manuel STATS_FILE="/home/ubuntu/.cursor/projects/workspace/uploads/stats_octobre_2025_mars_2026.csv" python3 analyse_groupes_bo.py`
2. `GROUPING_MODE=manuel STATS_FILE="/home/ubuntu/.cursor/projects/workspace/uploads/stats_octobre_2025_mars_2026.csv" python3 simulation_challenge.py`
...
> Note: ces fichiers historiques restent présents, mais le périmètre actif de regroupement/simulation est désormais **oct. 2025 → mars 2026** via `STATS_FILE`.
